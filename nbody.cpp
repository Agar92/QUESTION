...
int main(int argc, char **argv)
{
  ...
  MAX_ELEMENT=0;
#ifdef OPENACC
#pragma acc data create(ind01,ind23,arr1,arr2,arr3,csBorderDataFS,csMultipleScattering,csInelasticdd,csElasticEMIonIon,csElasticStrongIonIon) \
  copyin(d,inelasticddProcess)
  {
#endif
    bool InitLoop=true;
